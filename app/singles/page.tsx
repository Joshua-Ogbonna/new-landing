        ...
        <main className="flex-1 p-4 md:p-6 lg:p-8 overflow-y-auto pt-20 lg:pt-8">
          ...
          <div className="flex justify-between items-center mb-10">
            ...
            {status === 'authenticated' && songs.length != 0 && (
              <Link
                href="/newRelease"
                className="flex items-center gap-1 text-black bg-gradient-to-r from-[#FAFEEA] to-[#E7F89D] 
                hover:from-[#E7F89D] hover:to-[#FAFEEA] transform hover:scale-105 font-medium text-sm px-3 py-1.5 
                rounded-md hover:bg-opacity-90 transition duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
              >
                <FaPlus size={16} />
                <span className="hidden sm:inline">Create Single</span>
